!function(){
	var bP={};	
	var b=30, bb=150, height=500, buffMargin=1, minHeight=14;
	var c1=[-130, 40], c2=[-50, 100], c3=[-10, 140]; //Column positions of labels.
	//var colors =["#3366CC", "#DC3912",  "#FF9900","#109618", "#990099", "#0099C6"];
	var colors = ["#045a8d","#8c510a","#d8b365","#5ab4ac","#737373"];
	...
	function drawPart(data, id, p){
		...
		mainbar.append("rect").attr("class","mainrect")
			...
			.style("fill-opacity",0).style("stroke-width","2.0")
	...
	function drawEdges(data, id){
		...
		d3.select("#"+id).select(".edges").selectAll(".edge")
			...
			.style("opacity",0.3).each(function(d) { this._current = d; });	
	}	
	...
	bP.selectSegment = function(data, m, s){
		data.forEach(function(k){
			...
			selectedBar.select(".mainrect").style("stroke-opacity",2);			
